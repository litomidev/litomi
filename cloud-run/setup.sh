...
echo ""
echo "Note: The job will use the default Compute Engine service account."
echo "For production, consider creating a dedicated service account with minimal permissions."