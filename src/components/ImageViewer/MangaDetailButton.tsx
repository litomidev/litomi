  ...
  return (
    <>
      ...
      <Modal onClose={() => setIsOpened(false)} open={isOpened} showCloseButton showDragButton>
        <div className="bg-zinc-900 min-w-3xs w-screen max-w-sm md:max-w-lg rounded-xl p-4 pt-8 shadow-xl border grid gap-4 text-sm overflow-auto max-h-svh md:text-base">
          {/* Title */}
          <h2 className="font-bold text-lg md:text-xl">{title}</h2>
          {/* Description - Primary Information */}
          {description && (
            <div className="bg-zinc-800/30 rounded-lg p-3 -mx-1">
