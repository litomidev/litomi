...
export function IconFirstPage(props: Readonly<ComponentProps<'svg'>>) {
  return (
...
export function IconJumpNext(props: Readonly<ComponentProps<'svg'>>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24">
...
export function IconJumpPrev(props: Readonly<ComponentProps<'svg'>>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24">
...
export function IconLastPage(props: Readonly<ComponentProps<'svg'>>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24">
...
export function IconNextPage(props: Readonly<ComponentProps<'svg'>>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24">
...
export function IconPrevPage(props: Readonly<ComponentProps<'svg'>>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24">
