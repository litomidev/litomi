  ...
  return (
    <div className="p-4 md:p-16 [&_h2]:text-xl [&_h2]:font-semibold [&_ul]:list-disc [&_ul]:list-inside">
      <div className="max-w-prose mx-auto">
        ...
        <p className="mb-4">
          본 서비스는 많은 만화 작품을 수집하여 제공하는 것을 목적으로 하며, 여타 만화 사이트가 불법 도박, 피싱 광고로
          수익을 창출하는 것을 방지하기 위해 운영됩니다. 본 서비스는 이용자에게 평생 무료로 제공되며, '기다리면 무료'와
          같은 비즈니스 모델을 도입하지 않겠으며, 불법 광고를 통한 수익 창출을 목적으로 하지 않습니다.
        </p>
