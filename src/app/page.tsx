...
export default function Home() {
  return (
    <main className="h-dvh flex flex-col items-center justify-center gap-5 mx-auto p-4 text-center">
      ...
      <div className="grid gap-2 [&_a]:border [&_a]:rounded-lg [&_a]:w-60 [&_a]:py-2 [&_a]:font-semibold ">
        <Link
          className="bg-brand-gradient relative text-background before:absolute before:inset-0 before:rounded-lg before:border-2 before:border-white/40"
          href="/mangas/id/desc/1"
        >
          19세 이상 성인입니다
        </Link>
        ...
        <a
          className="border flex justify-center items-center gap-2 rounded"
          href="https://github.com/gwak2837/litomi"
          target="_blank"
        >
          <svg className=" align-middle fill-foreground w-6" viewBox="0 0 24 24">
