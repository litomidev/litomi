    ...
    <>
      ...
      >
        <div className="bg-zinc-900 rounded-xl p-6 border-2">
          <h3 className="text-lg font-semibold mb-4">데이터 내보내기 완료</h3>
          <p className="text-zinc-400 mb-4">
            데이터가 성공적으로 내보내졌어요. 다운로드한 파일을 안전한 곳에 보관해주세요.
          </p>
          <button
            className="w-full px-4 py-2 bg-zinc-800 hover:bg-zinc-700 rounded-lg font-medium transition"
